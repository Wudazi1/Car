...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, EEPEOM_I2C_SCL_Pin|EEPROM_I2C_SDA_Pin|MPU6050_SCL_Pin|MPU6050_SDA_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : BOTTOM_LED_Pin */
  GPIO_InitStruct.Pin = BOTTOM_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BOTTOM_LED_GPIO_Port, &GPIO_InitStruct);
