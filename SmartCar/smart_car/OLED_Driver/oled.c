...
/* 引脚宏定义 */
#define OLED_W_SCL_H  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_10, GPIO_PIN_SET)
#define OLED_W_SCL_L  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_10, GPIO_PIN_RESET)
#define OLED_W_SDA_H  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_11, GPIO_PIN_SET)
#define OLED_W_SDA_L  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_11, GPIO_PIN_RESET)
...
/**
  * @brief  I2C发送ACK/NACK
  * @param  ack: 0为ACK, 1为NACK
  * @retval 无
  */
void OLED_I2C_SendAck(uint8_t ack)
{
	if (ack) OLED_W_SDA_H; // NACK       
	else OLED_W_SDA_L; // ACK
